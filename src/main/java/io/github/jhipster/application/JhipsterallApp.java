...
public class JhipsterallApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterallApp.class);

    private final Environment env;

    public JhipsterallApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterall.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterallApp.class);
